...
const myCustomTitleValidator = (value: any, _args: any) => {
...
export default class Grid4 extends Component<Props, State> {
    state = {};
    ...
    commandQueue = [];
    frozenColumnCount: number = 2;
    frozenRowCount: number = 3;
    ...
    initializeGrid() {
        ...
        this.columnDefinitions = [
            ...
            },
            {
                ...
                minWidth: 100,
                editor: {
                    model: Editors.text, //Editors.autoComplete,
                ...
                filter: {
                    model: Filters.inputText, //Filters.autoComplete,
                    // placeholder: '🔎︎ search city',
    ...
    costDurationFormatter(_row: any, _cell: any, _value: any, _columnDef: any, dataContext: any) {
    ...
    handleOnValidationError(event: any) {
    ...
    handleOnItemDeleted(event: any) {
        const itemId = event && event.detail;
        console.log('item deleted with id:', itemId);
    }

    setFrozenRowCount = () => {
        const frozenRowCountEl = document.getElementById('frozenRowCount') as HTMLInputElement;
        const frozenRowCount = Number(frozenRowCountEl.value);
    ...
    setFrozenColumnsCount = () => {
        const frozenColumnCountEl = document.getElementById('frozenColumnCount') as HTMLInputElement;
        const frozenColumnCount = Number(frozenColumnCountEl.value);
    ...
    componentDidMount() {
        const frozenRowCountEl = document.getElementById('frozenRowCount') as HTMLInputElement;
        frozenRowCountEl.value = String(this.frozenRowCount);
        const frozenColumnCountEl = document.getElementById('frozenColumnCount') as HTMLInputElement;
        frozenColumnCountEl.value = String(this.frozenColumnCount);
    ...
    render() {
        return (
            <div>
                <h3 className="gridtitle is-3">Example 04 - Pinned (frozen) Columns/Rows</h3>
                <div className="row center">
                    <span style={{ verticalAlign: 'middle' }}>
                        <label className="labelx">Pinned Rows: </label>
                        <input
                            id="frozenRowCount"
                            type="number"
                            className="frozen-row-count"
                            onChange={() => {
                    ...
                    <span style={{ marginLeft: '10px', verticalAlign: 'middle' }}>
                        <label className="labelx">Pinned Columns: </label>
                        <input
                            id="frozenColumnCount"
                            type="number"
                            className="frozen-column-count"
                            
                            onChange={() => {
                                this.setFrozenColumnsCount();
                            }}
                        />
                        <button
                            className="btn btn-default btn-xs"
                            onClick={() => {
                                this.changeFrozenColumnCount();
                            }}
                        >
                            Set
                        </button>
                    ...
                    <span style={{ marginLeft: '15px' }}>
                        ...
                        >
                            <span className="icon mdi mdi-pin-outline"></span>
                            <span>Set 3 Frozen Columns</span>
                        </button>
                        <button
                            className="button is-small"
                            onClick={() => {
                                this.toggleFrozenBottomRows();
                            }}
                        >
                            <span className="icon mdi mdi-flip-vertical"></span>

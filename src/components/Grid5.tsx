...
export default class Grid5 extends Component<Props, State> {
        ...
        for (let i = 0; i < rowCount; i++) {
           ...
           */
            ...
            if (i === 3) {
                ...
                i === 2 ||
                i === 4 ||
                (Math.random() > 0.8 && i > 0 && indent < 3 && i - 1 !== 0 && i - 1 !== 2)
            ) {
    ...
    componentDidMount() {
        ...
        this.sgb = new Slicker.GridBundle(gridContainerElm, this.columnDefinitions, {
            ...ExampleGridOptions,
            ...this.gridOptions,
        });
        ...
        return (
            <div>
                ...
                <h6 className="title is-6 italic">
                    NOTE: The grid will automatically sort Ascending with the column that has the Tree Data, you could
                    add a "sortByFieldId" in your column "treeData" option if you wish to sort on a different column
                </h6>

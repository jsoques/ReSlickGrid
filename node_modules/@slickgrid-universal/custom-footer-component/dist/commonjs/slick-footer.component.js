...
class SlickFooterComponent {
    ...
    get locales() {
        ...
        return this.gridOptions.locales || common_1.Constants.locales;
    }
    set metrics(metrics) {
    ...
    createFooterContainer(gridParentContainerElm) {
        ...
        leftFooterElm.innerHTML = common_1.sanitizeTextByAvailableSanitizer(this.gridOptions, this.customFooterOptions.leftFooterText || '');
    ...
    createFooterRightContainer() {
        ...
        if (!this._isRightFooterOriginallyEmpty) {
            rightFooterElm.innerHTML = common_1.sanitizeTextByAvailableSanitizer(this.gridOptions, this.customFooterOptions.rightFooterText || '');
        }

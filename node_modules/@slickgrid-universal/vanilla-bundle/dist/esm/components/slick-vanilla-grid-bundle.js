...
export class SlickVanillaGridBundle {
    ...
    get dataset() {
        var _a, _b;
        return (_b = (_a = this.dataView) === null || _a === void 0 ? void 0 : _a.getItems()) !== null && _b !== void 0 ? _b : [];
    }
    ...
    set datasetHierarchical(newHierarchicalDataset) {
        ...
        if (newHierarchicalDataset && this.slickGrid && ((_b = this.sortService) === null || _b === void 0 ? void 0 : _b.processTreeDataInitialSort)) {
    ...
    dispose(shouldEmptyDomElementContainer = false) {
        ...
        (_b = this.extensionService) === null || _b === void 0 ? void 0 : _b.dispose();
        (_c = this.filterService) === null || _c === void 0 ? void 0 : _c.dispose();
        (_d = this.gridEventService) === null || _d === void 0 ? void 0 : _d.dispose();
        (_f = this.gridService) === null || _f === void 0 ? void 0 : _f.dispose();
        (_g = this.gridStateService) === null || _g === void 0 ? void 0 : _g.dispose();
        (_h = this.groupingService) === null || _h === void 0 ? void 0 : _h.dispose();
        (_j = this.paginationService) === null || _j === void 0 ? void 0 : _j.dispose();
        (_k = this.resizerService) === null || _k === void 0 ? void 0 : _k.dispose();
        (_l = this.sortService) === null || _l === void 0 ? void 0 : _l.dispose();
        (_m = this.treeDataService) === null || _m === void 0 ? void 0 : _m.dispose();
        ...
        (_o = this.slickFooter) === null || _o === void 0 ? void 0 : _o.dispose();
        (_p = this.slickEmptyWarning) === null || _p === void 0 ? void 0 : _p.dispose();
        (_q = this.slickPagination) === null || _q === void 0 ? void 0 : _q.dispose();
        (_r = this._eventPubSubService) === null || _r === void 0 ? void 0 : _r.unsubscribeAll();
        (_s = this.dataView) === null || _s === void 0 ? void 0 : _s.setItems([]);
        if ((_t = this.dataView) === null || _t === void 0 ? void 0 : _t.destroy) {
            (_u = this.dataView) === null || _u === void 0 ? void 0 : _u.destroy();
        }
        (_v = this.slickGrid) === null || _v === void 0 ? void 0 : _v.destroy(true);
        this.slickGrid = null;
    ...
    initialization(gridContainerElm, eventHandler) {
        ...
        const selectionModel = (_r = (_q = this.slickGrid) === null || _q === void 0 ? void 0 : _q.getSelectionModel) === null || _r === void 0 ? void 0 : _r.call(_q);
        ...
        if ((_t = this.gridOptions) === null || _t === void 0 ? void 0 : _t.backendServiceApi) {
        ...
        this._slickerGridInstances = {
            ...
            backendService: (_v = (_u = this.gridOptions) === null || _u === void 0 ? void 0 : _u.backendServiceApi) === null || _v === void 0 ? void 0 : _v.service,
        ...
        this._extensions = (_w = this.extensionService) === null || _w === void 0 ? void 0 : _w.extensionList;
    ...
    loadRowSelectionPresetWhenExists() {
        ...
        if (enableRowSelection && selectionModel && (presets === null || presets === void 0 ? void 0 : presets.rowSelection) && (Array.isArray(presets.rowSelection.gridRowIndexes) || Array.isArray(presets.rowSelection.dataContextIds))) {

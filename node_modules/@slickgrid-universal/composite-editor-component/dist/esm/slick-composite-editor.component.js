...
import { BindingEventService, Constants, deepCopy, emptyObject, getDescendantProperty, numericSortComparer, sanitizeTextByAvailableSanitizer, setDeepValue, SortDirectionNumber, } from '@slickgrid-universal/common';
...
export class SlickCompositeEditorComponent {
    ...
    openDetails(options) {
        ...
        try {
            ...
            if (!this.gridOptions.editable) {
                ...
                const fullDataset = (_g = (_f = this.dataView) === null || _f === void 0 ? void 0 : _f.getItems()) !== null && _g !== void 0 ? _g : [];
                const fullDatasetLength = (Array.isArray(fullDataset)) ? fullDataset.length : 0;
                this._lastActiveRowNumber = activeRow;
                const gridStateSelection = (_h = this.gridStateService) === null || _h === void 0 ? void 0 : _h.getCurrentRowSelections();
                const dataContextIds = (gridStateSelection === null || gridStateSelection === void 0 ? void 0 : gridStateSelection.dataContextIds) || [];
                ...
                if ((_m = this._options) === null || _m === void 0 ? void 0 : _m.showFormResetButton) {
            ...
            this.dispose();
            const errorMsg = (typeof error === 'string') ? error : ((_q = (_o = error === null || error === void 0 ? void 0 : error.message) !== null && _o !== void 0 ? _o : (_p = error === null || error === void 0 ? void 0 : error.body) === null || _p === void 0 ? void 0 : _p.message) !== null && _q !== void 0 ? _q : '');
            const errorCode = (typeof error === 'string') ? error : (_t = (_r = error === null || error === void 0 ? void 0 : error.status) !== null && _r !== void 0 ? _r : (_s = error === null || error === void 0 ? void 0 : error.body) === null || _s === void 0 ? void 0 : _s.status) !== null && _t !== void 0 ? _t : errorMsg;
    ...
    getCurrentRowSelections() {
        var _a;
        const gridStateSelection = (_a = this.gridStateService) === null || _a === void 0 ? void 0 : _a.getCurrentRowSelections();
        const gridRowIndexes = (gridStateSelection === null || gridStateSelection === void 0 ? void 0 : gridStateSelection.gridRowIndexes) || [];
        const dataContextIds = (gridStateSelection === null || gridStateSelection === void 0 ? void 0 : gridStateSelection.dataContextIds) || [];
    ...
    insertNewItemInDataView(item) {
        var _a, _b, _c, _d;
        const fullDataset = (_b = (_a = this.dataView) === null || _a === void 0 ? void 0 : _a.getItems()) !== null && _b !== void 0 ? _b : [];
        const fullDatasetLength = (Array.isArray(fullDataset)) ? fullDataset.length : 0;

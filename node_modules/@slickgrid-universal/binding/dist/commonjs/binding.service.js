...
class BindingService {
     ...
     */
    bind(elements, attribute, eventName, callback) {
        if (elements && elements.forEach) {
            // multiple DOM elements coming from a querySelectorAll() call
            elements.forEach(elm => this.bindSingleElement(elm, attribute, eventName, callback));
        }
        else if (elements) {
            // single DOM element coming from a querySelector() call
            this.bindSingleElement(elements, attribute, eventName, callback);
        }
        return this;
    }
     ...
     *    2.1- we could also provide an extra callback method to execute when the event gets triggered
     */
    bindSingleElement(element, attribute, eventName, callback) {

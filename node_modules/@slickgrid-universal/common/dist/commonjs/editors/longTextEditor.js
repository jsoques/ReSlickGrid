...
class LongTextEditor {
    ...
    init() {
        ...
        const placeholder = (_r = (_q = this.columnEditor) === null || _q === void 0 ? void 0 : _q.placeholder) !== null && _r !== void 0 ? _r : '';
        const title = (_t = (_s = this.columnEditor) === null || _s === void 0 ? void 0 : _s.title) !== null && _t !== void 0 ? _t : '';
        const maxLength = (_u = this.columnEditor) === null || _u === void 0 ? void 0 : _u.maxLength;
        const textAreaCols = (_w = (_v = this.editorOptions) === null || _v === void 0 ? void 0 : _v.cols) !== null && _w !== void 0 ? _w : 40;
        const textAreaRows = (_y = (_x = this.editorOptions) === null || _x === void 0 ? void 0 : _x.rows) !== null && _y !== void 0 ? _y : 4;
        ...
        this._textareaElm.setAttribute('aria-label', (_0 = (_z = this.columnEditor) === null || _z === void 0 ? void 0 : _z.ariaLabel) !== null && _0 !== void 0 ? _0 : `${utilities_1.toSentenceCase(columnId + '')} Text Editor`);
    ...
    position(parentPosition) {
        ...
        const containerOffset = utilities_1.getHtmlElementOffset(this.args.container);
    ...
    validate(_targetElm, inputValue) {
        ...
        return textValidator_1.textValidator(elmValue, {
    ...
    handleKeyDown(event) {
        ...
        if (!this.args.compositeEditorOptions) {
            if (keyCode === keyCode_enum_1.KeyCode.ENTER && event.ctrlKey) {
                this.save();
            }

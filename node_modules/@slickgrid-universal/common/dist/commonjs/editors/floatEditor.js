...
class FloatEditor extends inputEditor_1.InputEditor {
    ...
    init() {
        ...
        if (this.columnDef && this.columnEditor && this.args) {
            ...
            this._input.setAttribute('aria-label', (_h = (_g = this.columnEditor) === null || _g === void 0 ? void 0 : _g.ariaLabel) !== null && _h !== void 0 ? _h : `${utilities_1.toSentenceCase(columnId + '')} Number Editor`);
    ...
    validate(_targetElm, inputValue) {
        ...
        return floatValidator_1.floatValidator(elmValue, {

...
class DateEditor {
    ...
    init() {
        ...
        if (this.args && this.columnDef) {
            ...
            const inputFormat = utilities_1.mapFlatpickrDateFormatWithFieldType(this.columnEditor.type || this.columnDef.type || index_1.FieldType.dateUtc);
            const outputFormat = utilities_1.mapFlatpickrDateFormatWithFieldType(this.columnDef.outputType || this.columnEditor.type || this.columnDef.type || index_1.FieldType.dateUtc);
            let currentLocale = ((_f = (_e = this._translaterService) === null || _e === void 0 ? void 0 : _e.getCurrentLanguage) === null || _f === void 0 ? void 0 : _f.call(_e)) || gridOptions.locale || 'en';
          ...
          See Flatpickr Localization for more info, for example if we want to use French, then we can import it with:  import 'flatpickr/dist/l10n/fr';`);
            ...
            this._inputWithDataElm = ((_j = this._pickerMergedOptions) === null || _j === void 0 ? void 0 : _j.altInput) ? document.querySelector(`${inputCssClasses}.flatpickr-alt-input`) : this._inputElm;
    ...
    destroy() {
        ...
        if ((_a = this.flatInstance) === null || _a === void 0 ? void 0 : _a.destroy) {
            ...
            if ((_b = this.flatInstance) === null || _b === void 0 ? void 0 : _b.element) {
                setTimeout(() => utilities_1.destroyObjectDomElementProps(this.flatInstance));
            }
        }
        utilities_1.emptyElement(this._editorInputGroupElm);
        utilities_1.emptyElement(this._inputWithDataElm);
        utilities_1.emptyElement(this._inputElm);
    ...
    focus() {
        var _a, _b;
        if ((_a = this._inputElm) === null || _a === void 0 ? void 0 : _a.focus) {
    ...
    applyValue(item, state) {
        ...
        if (fieldName !== undefined) {
            const outputTypeFormat = utilities_1.mapMomentDateFormatWithFieldType((this.columnDef && (this.columnDef.outputType || this.columnEditor.type || this.columnDef.type)) || index_1.FieldType.dateUtc);
            const saveTypeFormat = utilities_1.mapMomentDateFormatWithFieldType((this.columnDef && (this.columnDef.saveOutputType || this.columnDef.outputType || this.columnEditor.type || this.columnDef.type)) || index_1.FieldType.dateUtc);
    ...
    isValueChanged() {
        ...
        const inputFormat = utilities_1.mapMomentDateFormatWithFieldType(this.columnEditor.type || ((_a = this.columnDef) === null || _a === void 0 ? void 0 : _a.type) || index_1.FieldType.dateIso);
        const outputTypeFormat = utilities_1.mapMomentDateFormatWithFieldType((this.columnDef && (this.columnDef.outputType || this.columnEditor.type || this.columnDef.type)) || index_1.FieldType.dateUtc);
    ...
    loadValue(item) {
        ...
        if (item && fieldName !== undefined) {
            ...
            const value = (isComplexObject) ? utilities_1.getDescendantProperty(item, fieldName) : item[fieldName];
    ...
    serializeValue() {
        ...
        const inputFormat = utilities_1.mapMomentDateFormatWithFieldType(this.columnEditor.type || ((_a = this.columnDef) === null || _a === void 0 ? void 0 : _a.type) || index_1.FieldType.dateIso);
        const outputTypeFormat = utilities_1.mapMomentDateFormatWithFieldType((this.columnDef && (this.columnDef.outputType || this.columnEditor.type || this.columnDef.type)) || index_1.FieldType.dateIso);

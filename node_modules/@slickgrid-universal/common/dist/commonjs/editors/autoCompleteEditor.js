...
exports.AutoCompleteEditor = void 0;
...
class AutoCompleteEditor {
    ...
    applyValue(item, state) {
        ...
        if (fieldName !== undefined) {
            ...
            if (Array.isArray(this.collection) && this.collection.length > 0) {
                newValue = utilities_1.findOrDefault(this.collection, (collectionItem) => {
    ...
    isValueChanged() {
        ...
        if (this.columnEditor && this.columnEditor.alwaysSaveOnEnterKey && lastKeyEvent === index_1.KeyCode.ENTER) {
            return true;
        }
    ...
    loadValue(item) {
        ...
        if (item && fieldName !== undefined) {
            // is the field a complex object, "address.streetNumber"
            const isComplexObject = (fieldName === null || fieldName === void 0 ? void 0 : fieldName.indexOf('.')) > 0;
            const data = (isComplexObject) ? utilities_1.getDescendantProperty(item, fieldName) : item[fieldName];
    ...
    validate(_targetElm, inputValue) {
        ...
        return textValidator_1.textValidator(val, {
    ...
    renderDomElement(collection) {
        ...
        if (this.columnEditor.alwaysSaveOnEnterKey) {
            this._$input.keydown((event) => {
                if (event.keyCode === index_1.KeyCode.ENTER) {

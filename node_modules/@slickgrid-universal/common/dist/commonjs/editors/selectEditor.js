...
class SelectEditor {
    ...
    get currentValue() {
        ...
        if (fieldName !== undefined) {
            // collection of strings, just return the filtered string that are equals
            if (this.collection.every(x => typeof x === 'string')) {
                return index_2.findOrDefault(this.collection, (c) => { var _a; return ((_a = c === null || c === void 0 ? void 0 : c.toString) === null || _a === void 0 ? void 0 : _a.call(c)) === elmValue; });
            }
            // collection of label/value pair
            ...
            const itemFound = index_2.findOrDefault(this.collection, (c) => { var _a; return c.hasOwnProperty(this.valueName) && ((_a = c[this.valueName]) === null || _a === void 0 ? void 0 : _a.toString()) === elmValue; });
            // is the field a complex object, "address.streetNumber"
            const isComplexObject = (fieldName === null || fieldName === void 0 ? void 0 : fieldName.indexOf('.')) > 0;
    ...
    loadValue(item) {
        ...
        if (item && fieldName !== undefined) {
            ...
            const currentValue = (isComplexObject) ? utilities_1.getDescendantProperty(item, objectPath) : (item.hasOwnProperty(fieldName) && item[fieldName]);
    ...
    isValueChanged() {
        ...
        if (this.isMultipleSelect) {
            const isEqual = lite_1.dequal(valueSelection, this.originalValue);
            return !isEqual;
        }
    ...
    renderDomElement(inputCollection) {
        ...
        const selectBuildResult = index_2.buildSelectEditorOrFilterDomElement('editor', finalCollection, this.columnDef, this.grid, this.isMultipleSelect, this._translaterService);

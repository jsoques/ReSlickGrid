...
class InputEditor {
    ...
    init() {
        ...
        this._input.setAttribute('aria-label', (_h = (_g = this.columnEditor) === null || _g === void 0 ? void 0 : _g.ariaLabel) !== null && _h !== void 0 ? _h : `${utilities_1.toSentenceCase(columnId + '')} Input Editor`);
    ...
    loadValue(item) {
        ...
        if (item && fieldName !== undefined && this._input) {
            ...
            const value = (isComplexObject) ? utilities_1.getDescendantProperty(item, fieldName) : (item.hasOwnProperty(fieldName) && item[fieldName] || '');

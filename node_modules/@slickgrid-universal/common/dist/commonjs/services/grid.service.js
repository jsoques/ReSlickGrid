...
const GridServiceUpdateOptionDefaults = { highlightRow: false, selectRow: false, scrollRowIntoView: false, triggerEvent: true };
...
class GridService {
    ...
    hideColumnById(columnId, options) {
        ...
        if (this._grid && this._grid.getColumns && this._grid.setColumns) {
            ...
            if (colIndexFound >= 0) {
                const visibleColumns = utilities_1.arrayRemoveItemByIndex(currentColumns, colIndexFound);
    ...
    addItem(item, options) {
        ...
        let rowNumber = 0;
        const itemId = (_d = (_c = item) === null || _c === void 0 ? void 0 : _c[idPropName]) !== null && _d !== void 0 ? _d : '';
        if ((_e = this._gridOptions) === null || _e === void 0 ? void 0 : _e.enableTreeData) {
    ...
    deleteItems(items, options) {
        ...
        items.forEach((item) => {
            var _a;
            if (((_a = item) === null || _a === void 0 ? void 0 : _a[idPropName]) !== undefined) {

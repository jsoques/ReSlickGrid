...
class TreeDataService {
    ...
    convertFlatParentChildToTreeDataset(flatDataset, gridOptions) {
        ...
        return utilities_1.unflattenParentChildArrayToTree(flatDataset, treeDataOptions);
    }
    /**
            ...
            if (targetElm === null || targetElm === void 0 ? void 0 : targetElm.className) {
                ...
                if (hasToggleClass) {
                    ...
                    if (item) {
                        ...
                        const treeItemFound = utilities_1.findItemInTreeStructure(this.sharedService.hierarchicalDataset || [], searchTreePredicate, childrenPropName);
                        if (treeItemFound) {

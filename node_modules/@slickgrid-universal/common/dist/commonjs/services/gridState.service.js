...
class GridStateService {
    ...
    getCurrentGridState(args) {
        ...
        if (this.hasRowSelectionEnabled()) {
            const currentRowSelection = this.getCurrentRowSelections(args === null || args === void 0 ? void 0 : args.requestRefreshRowFilteredRow);
    ...
    subscribeToAllGridChanges(grid) {
        ...
        this._subscriptions.push(this.pubSubService.subscribe('onFilterChanged', (currentFilters) => {
            ...
            this.pubSubService.publish('onGridStateChanged', { change: { newValues: currentFilters, type: index_1.GridStateType.filter }, gridState: this.getCurrentGridState({ requestRefreshRowFilteredRow: !this.hasRowSelectionEnabled() }) });
    ...
    bindSlickGridColumnChangeEventToGridStateChange(eventName, grid) {
        var _a;
        const slickGridEvent = (_a = grid) === null || _a === void 0 ? void 0 : _a[eventName];
    ...
    bindSlickGridRowSelectionToGridStateChange() {
        if (this._grid && this._gridOptions && this._dataView) {
            ...
            this._eventHandler.subscribe(onBeforePagingInfoChangedHandler, () => {
            ...
            this._eventHandler.subscribe(onPagingInfoChangedHandler, () => {
                ...
                setTimeout(() => {
                    ...
                    if (!lite_1.dequal(shouldBeSelectedRowIndexes, currentSelectedRowIndexes)) {
            ...
            this._eventHandler.subscribe(onSelectedRowsChangedHandler, (_e, args) => {
                if (Array.isArray(args.rows) && Array.isArray(args.previousSelectedRows)) {
                    ...
                    const shouldBeSelectedRowIndexes = this._dataView.mapIdsToRows(this._selectedRowDataContextIds || []);
                    const currentSelectedRowIndexes = this._grid.getSelectedRows();
                    if (!lite_1.dequal(shouldBeSelectedRowIndexes, currentSelectedRowIndexes) && this._gridOptions.enablePagination) {
                        this._grid.setSelectedRows(shouldBeSelectedRowIndexes);
                    }
    ...
    reEvaluateRowSelectionAfterFilterChange() {
        ...
        if (!lite_1.dequal(this._selectedFilteredRowDataContextIds, previousSelectedFilteredRowDataContextIds)) {
            ...
            this.pubSubService.publish('onGridStateChanged', { change: { newValues, type: index_1.GridStateType.rowSelection }, gridState: this.getCurrentGridState({ requestRefreshRowFilteredRow: false }) });
        }
    }

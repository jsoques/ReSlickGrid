...
exports.buildSelectEditorOrFilterDomElement = void 0;
        ...
        if (collection.every((x) => typeof x === 'string')) {
            ...
            collection.forEach((option) => {
                ...
                if (isRenderHtmlEnabled) {
                    ...
                    const sanitizedText = utilities_1.sanitizeTextByAvailableSanitizer(gridOptions, optionText, sanitizedOptions);

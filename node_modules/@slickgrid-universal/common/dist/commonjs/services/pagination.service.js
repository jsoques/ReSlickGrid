...
class PaginationService {
    ...
    get dataView() {
        var _a;
        return (((_a = this.grid) === null || _a === void 0 ? void 0 : _a.getData) && this.grid.getData());
    }
    ...
    init(grid, paginationOptions, backendServiceApi) {
        ...
        if (this._isLocalGrid && this.dataView) {
            ...
            this._eventHandler.subscribe(onPagingInfoChangedHandler, (_e, pagingInfo) => {
        ...
        if (this.dataView) {
            this._subscriptions.push(this.pubSubService.subscribe(`onItemAdded`, (items) => {
    ...
    refreshPagination(isPageNumberReset = false, triggerChangedEvent = true, triggerInitializedEvent = false) {
        ...
        if (triggerChangedEvent && !lite_1.dequal(previousPagination, this.getFullPagination())) {
        ...
        if (triggerInitializedEvent && !lite_1.dequal(previousPagination, this.getFullPagination())) {

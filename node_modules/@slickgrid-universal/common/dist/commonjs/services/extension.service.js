...
class ExtensionService {
    ...
    bindDifferentExtensions() {
        if (this.sharedService && this.sharedService.gridOptions) {
            ...
            if (this.sharedService.gridOptions.enableAutoTooltip && this.autoTooltipExtension && this.autoTooltipExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.autoTooltip] = { name: index_1.ExtensionName.autoTooltip, class: this.autoTooltipExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableExcelCopyBuffer && this.cellExternalCopyExtension && this.cellExternalCopyExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.cellExternalCopyManager] = { name: index_1.ExtensionName.cellExternalCopyManager, class: this.cellExternalCopyExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableCellMenu && this.cellMenuExtension && this.cellMenuExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.cellMenu] = { name: index_1.ExtensionName.cellMenu, class: this.cellMenuExtension, instance };
                }
            }
            ...
            if (!this.getExtensionByName(index_1.ExtensionName.rowSelection) && (this.sharedService.gridOptions.enableRowSelection || this.sharedService.gridOptions.enableCheckboxSelector || this.sharedService.gridOptions.enableRowDetailView || this.sharedService.gridOptions.enableRowMoveManager)) {
                if (this.rowSelectionExtension && this.rowSelectionExtension.register) {
                    const instance = this.rowSelectionExtension.register();
                    if (instance) {
                        this._extensionList[index_1.ExtensionName.rowSelection] = { name: index_1.ExtensionName.rowSelection, class: this.rowSelectionExtension, instance };
                    }
                }
            }
            ...
            if (this.sharedService.gridOptions.enableCheckboxSelector && this.checkboxSelectorExtension && this.checkboxSelectorExtension.register) {
                const rowSelectionExtension = this.getExtensionByName(index_1.ExtensionName.rowSelection);
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.checkboxSelector] = { name: index_1.ExtensionName.checkboxSelector, class: this.checkboxSelectorExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableColumnPicker && this.columnPickerExtension && this.columnPickerExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.columnPicker] = { name: index_1.ExtensionName.columnPicker, class: this.columnPickerExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableContextMenu && this.contextMenuExtension && this.contextMenuExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.contextMenu] = { name: index_1.ExtensionName.contextMenu, class: this.contextMenuExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableDraggableGrouping && this.draggableGroupingExtension && this.draggableGroupingExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.draggableGrouping] = { name: index_1.ExtensionName.draggableGrouping, class: this.draggableGroupingExtension, instance };
                }
            }
            // Grid Menu Control
            if (this.sharedService.gridOptions.enableGridMenu && this.gridMenuExtension && this.gridMenuExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.gridMenu] = { name: index_1.ExtensionName.gridMenu, class: this.gridMenuExtension, instance };
                }
            }
            // Grouping Plugin
            ...
            if (this.sharedService.gridOptions.enableDraggableGrouping || this.sharedService.gridOptions.enableGrouping) {
                if (this.groupItemMetaExtension && this.groupItemMetaExtension.register) {
                    ...
                    if (instance) {
                        this._extensionList[index_1.ExtensionName.groupItemMetaProvider] = { name: index_1.ExtensionName.groupItemMetaProvider, class: this.groupItemMetaExtension, instance };
                    }
                }
            }
            ...
            if (this.sharedService.gridOptions.enableHeaderButton && this.headerButtonExtension && this.headerButtonExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.headerButton] = { name: index_1.ExtensionName.headerButton, class: this.headerButtonExtension, instance };
                }
            }
            // Header Menu Plugin
            if (this.sharedService.gridOptions.enableHeaderMenu && this.headerMenuExtension && this.headerMenuExtension.register) {
                ...
                if (instance) {
                    this._extensionList[index_1.ExtensionName.headerMenu] = { name: index_1.ExtensionName.headerMenu, class: this.headerMenuExtension, instance };
                }
            }
            ...
            if (this.sharedService.gridOptions.enableRowDetailView) {
                if (this.rowDetailViewExtension && this.rowDetailViewExtension.register) {
                    ...
                    const createdExtension = this.getCreatedExtensionByName(index_1.ExtensionName.rowDetailView); // get the plugin from when it was really created earlier
                    const instance = createdExtension && createdExtension.instance;
                    if (instance) {
                        this._extensionList[index_1.ExtensionName.rowDetailView] = { name: index_1.ExtensionName.rowDetailView, class: this.rowDetailViewExtension, instance };
                    }
                }
            }
            ...
            if (this.sharedService.gridOptions.enableRowMoveManager && this.rowMoveManagerExtension && this.rowMoveManagerExtension.register) {
                ...
                const instance = createdExtension && createdExtension.instance;
                if (instance) {
                    this._extensionList[index_1.ExtensionName.rowMoveManager] = { name: index_1.ExtensionName.rowMoveManager, class: this.rowMoveManagerExtension, instance };
                }
            }
        }
    }
    ...
    createExtensionsBeforeGridCreation(columnDefinitions, gridOptions) {
        ...
        if (gridOptions.enableRowDetailView) {
            if (!this.getCreatedExtensionByName(index_1.ExtensionName.rowDetailView)) {
        ...
        if (gridOptions.enableDraggableGrouping) {
            if (!this.getCreatedExtensionByName(index_1.ExtensionName.draggableGrouping)) {
                ...
                if (draggableInstance) {
                    ...
                    this._extensionCreatedList[index_1.ExtensionName.draggableGrouping] = { name: index_1.ExtensionName.draggableGrouping, instance: draggableInstance, class: this.draggableGroupingExtension };
                }
            }
        }
    }
    ...
    renderColumnHeaders(newColumnDefinitions, forceColumnDefinitionsOverwrite = false) {
        ...
        if (this.sharedService.gridOptions.enableColumnPicker) {
            this.recreateExternalAddon(this.columnPickerExtension, index_1.ExtensionName.columnPicker);
        }
        // recreate the Grid Menu when enabled
        if (this.sharedService.gridOptions.enableGridMenu) {
            this.recreateExternalAddon(this.gridMenuExtension, index_1.ExtensionName.gridMenu);
        }
        // recreate the Header Menu when enabled
        if (this.sharedService.gridOptions.enableHeaderMenu) {
            this.recreateExternalAddon(this.headerMenuExtension, index_1.ExtensionName.headerMenu);
        }
    }
    //
    // protected functions

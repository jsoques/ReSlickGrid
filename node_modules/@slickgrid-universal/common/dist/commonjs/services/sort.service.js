...
class SortService {
    ...
    bindBackendOnSort(grid) {
        ...
        this._grid = grid;
        this._dataView = (grid === null || grid === void 0 ? void 0 : grid.getData) && grid.getData();
        // subscribe to the SlickGrid event and call the backend execution
        const onSortHandler = grid.onSort;
        this._eventHandler.subscribe(onSortHandler, this.onBackendSortChanged.bind(this));
    }
    /**
    ...
    bindLocalOnSort(grid) {
        ...
        const onSortHandler = grid.onSort;
        this._eventHandler.subscribe(onSortHandler, this.handleLocalOnSort.bind(this));
    }
    ...
    emitSortChanged(sender, currentLocalSorters) {
        if (sender === index_1.EmitterType.remote && this._gridOptions && this._gridOptions.backendServiceApi) {
            let currentSorters = [];
    ...
    onBackendSortChanged(event, args) {
        ...
        (_a = this.backendUtilities) === null || _a === void 0 ? void 0 : _a.executeBackendCallback(backendApi, query, args, startTime, totalItems, this.emitSortChanged.bind(this), this.httpCancelRequests$);
    }
    ...
    sortHierarchicalDataset(hierarchicalDataset, sortColumns) {
        var _a, _b, _c, _d, _f;
        ...
        const sortedFlatArray = utilities_1.flattenToParentChildArray(hierarchicalDataset, treeDataOptions);
    ...
    sortComparer(sortColumn, dataRow1, dataRow2, querySortField) {
        if (sortColumn === null || sortColumn === void 0 ? void 0 : sortColumn.sortCol) {
            ...
            if (queryFieldName1 && queryFieldName1.indexOf('.') >= 0) {
                value1 = utilities_1.getDescendantProperty(dataRow1, queryFieldName1);
            }
            if (queryFieldName2 && queryFieldName2.indexOf('.') >= 0) {
                value2 = utilities_1.getDescendantProperty(dataRow2, queryFieldName2);
            }
            ...
            if (columnDef.sortComparer) {
                ...
                const sortResult = sortUtilities_1.sortByFieldType(fieldType, value1, value2, sortDirection, columnDef, this._gridOptions);
    ...
    sortTreeChild(treeArray, sortColumn, treeLevel) {
        var _a, _b;

...
class GroupingAndColspanService {
    ...
    init(grid) {
        ...
        if (grid && this._gridOptions) {
            ...
            if (this._gridOptions.createPreHeaderPanel) {
                ...
                const columnPickerExtension = this.extensionService.getExtensionByName(index_1.ExtensionName.columnPicker);
                ...
                const gridMenuExtension = this.extensionService.getExtensionByName(index_1.ExtensionName.gridMenu);
    ...
    renderHeaderGroups(preHeaderPanel, start, end) {
        var _a, _b, _c;
        utilities_1.emptyElement(preHeaderPanel);

...
exports.ContextMenuExtension = void 0;
    ...
    copyToClipboard(args) {
        try {
            if (args && args.grid && args.command) {
                ...
                let textToCopy = formatterUtilities_1.exportWithFormatterWhenDefined(row, cell, columnDef, dataContext, grid, exportOptions);
                if (typeof columnDef.queryFieldNameGetterFn === 'function') {
    ...
    getCellValueFromQueryFieldGetter(columnDef, dataContext) {
        ...
        if (typeof columnDef.queryFieldNameGetterFn === 'function') {
            ...
            if ((queryFieldName === null || queryFieldName === void 0 ? void 0 : queryFieldName.indexOf('.')) >= 0) {
                cellValue = utilities_1.getDescendantProperty(dataContext, queryFieldName);
            }
            else {

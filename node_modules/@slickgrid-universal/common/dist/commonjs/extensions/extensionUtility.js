...
class ExtensionUtility {
    constructor(sharedService, translaterService) {
    ...
    getPickerTitleOutputString(propName, pickerName) {
        ...
        const title = (_g = picker) === null || _g === void 0 ? void 0 : _g[propName];
        const titleKey = (_h = picker) === null || _h === void 0 ? void 0 : _h[`${propName}Key`];
        const gridOptions = this.sharedService.gridOptions;
        const translationPrefix = utilities_1.getTranslationPrefix(gridOptions);
        if (titleKey && ((_j = this.translaterService) === null || _j === void 0 ? void 0 : _j.translate)) {
            output = this.translaterService.translate(titleKey || ' ');
        }
        else {
            switch (propName) {
                case 'customTitle':
                    output = title || enableTranslate && ((_k = this.translaterService) === null || _k === void 0 ? void 0 : _k.getCurrentLanguage) && ((_l = this.translaterService) === null || _l === void 0 ? void 0 : _l.translate(`${translationPrefix}COMMANDS` || ' ')) || (locales === null || locales === void 0 ? void 0 : locales.TEXT_COMMANDS);
                    break;
                case 'columnTitle':
                    output = title || enableTranslate && ((_m = this.translaterService) === null || _m === void 0 ? void 0 : _m.getCurrentLanguage) && ((_o = this.translaterService) === null || _o === void 0 ? void 0 : _o.translate(`${translationPrefix}COLUMNS` || ' ')) || (locales === null || locales === void 0 ? void 0 : locales.TEXT_COLUMNS);
                    break;
                case 'forceFitTitle':
                    output = title || enableTranslate && ((_p = this.translaterService) === null || _p === void 0 ? void 0 : _p.getCurrentLanguage) && ((_q = this.translaterService) === null || _q === void 0 ? void 0 : _q.translate(`${translationPrefix}FORCE_FIT_COLUMNS` || ' ')) || (locales === null || locales === void 0 ? void 0 : locales.TEXT_FORCE_FIT_COLUMNS);
                    break;
                case 'syncResizeTitle':
                    output = title || enableTranslate && ((_r = this.translaterService) === null || _r === void 0 ? void 0 : _r.getCurrentLanguage) && ((_s = this.translaterService) === null || _s === void 0 ? void 0 : _s.translate(`${translationPrefix}SYNCHRONOUS_RESIZE` || ' ')) || (locales === null || locales === void 0 ? void 0 : locales.TEXT_SYNCHRONOUS_RESIZE);
                    break;
                default:
                    output = title;
                    break;

...
exports.CellMenuExtension = void 0;
require("slickgrid/plugins/slick.cellmenu");
const constants_1 = require("../constants");
class CellMenuExtension {
    ...
    register() {
        ...
        if (this.sharedService && this.sharedService.slickGrid && this.sharedService.gridOptions) {
            ...
            this._locales = this.sharedService.gridOptions && this.sharedService.gridOptions.locales || constants_1.Constants.locales;

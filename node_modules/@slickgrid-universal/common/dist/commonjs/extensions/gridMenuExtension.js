...
exports.GridMenuExtension = void 0;
require("slickgrid/controls/slick.gridmenu");
const index_1 = require("../enums/index");
const utilities_1 = require("../services/utilities");
class GridMenuExtension {
    constructor(extensionUtility, filterService, sharedService, sortService, backendUtilities, translaterService) {
    ...
    dispose() {
        ...
        if ((_a = this._addon) === null || _a === void 0 ? void 0 : _a.destroy) {
            this._addon.destroy();
        }
        if ((_c = (_b = this.sharedService.gridOptions) === null || _b === void 0 ? void 0 : _b.gridMenu) === null || _c === void 0 ? void 0 : _c.customItems) {
    ...
    register() {
        var _a, _b, _c;
        if (((_a = this.sharedService.gridOptions) === null || _a === void 0 ? void 0 : _a.enableTranslate) && (!this.translaterService || !this.translaterService.translate)) {
            throw new Error('[Slickgrid-Universal] requires a Translate Service to be installed and configured when the grid option "enableTranslate" is enabled.');
        }
        if ((_c = (_b = this.sharedService) === null || _b === void 0 ? void 0 : _b.gridOptions) === null || _c === void 0 ? void 0 : _c.gridMenu) {
            ...
            if (this.sharedService.slickGrid && this._gridMenuOptions) {
                ...
                if (this._gridMenuOptions && typeof this._gridMenuOptions.onBeforeMenuShow === 'function') {
                    ...
                    if (onBeforeMenuShowHandler) {
                        this._eventHandler.subscribe(onBeforeMenuShowHandler, (e, args) => {
                ...
                if (this._gridMenuOptions && typeof this._gridMenuOptions.onAfterMenuShow === 'function') {
                    ...
                    if (onAfterMenuShowHandler) {
                        this._eventHandler.subscribe(onAfterMenuShowHandler, (e, args) => {
                ...
                if (onMenuCloseHandler) {
                    this._eventHandler.subscribe(onMenuCloseHandler, (e, args) => {
    ...
    refreshBackendDataset(gridOptions) {
        ...
        (_a = this.backendUtilities) === null || _a === void 0 ? void 0 : _a.refreshBackendDataset(this.sharedService.gridOptions);
    }
    showGridMenu(e) {
        if (this._addon) {
    ...
    translateGridMenu() {
        ...
        if ((_b = (_a = this.sharedService) === null || _a === void 0 ? void 0 : _a.gridOptions) === null || _b === void 0 ? void 0 : _b.gridMenu) {
            ...
            if ((_c = this._addon) === null || _c === void 0 ? void 0 : _c.updateAllTitles) {
    ...
    addGridMenuCustomCommands(originalCustomItems) {
        ...
        const translationPrefix = utilities_1.getTranslationPrefix(gridOptions);
        ...
        if (this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideClearFrozenColumnsCommand) {
            ...
            if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                gridMenuCustomItems.push({
                    ...
                    title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearFrozenColumnsCommandKey}`, 'TEXT_CLEAR_PINNING', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearFrozenColumnsCommand),
                    disabled: false,
                    command: commandName,
                    positionOrder: 52
                });
            ...
            if (this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideClearAllFiltersCommand) {
                ...
                if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                    gridMenuCustomItems.push({
                        ...
                        title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearAllFiltersCommandKey}`, 'TEXT_CLEAR_ALL_FILTERS', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearAllFiltersCommand),
                        disabled: false,
                        command: commandName,
                        positionOrder: 50
                    });
            ...
            if (this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideToggleFilterCommand) {
                ...
                if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                    gridMenuCustomItems.push({
                        ...
                        title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.toggleFilterCommandKey}`, 'TEXT_TOGGLE_FILTER_ROW', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.toggleFilterCommand),
                        disabled: false,
                        command: commandName,
                        positionOrder: 53
                    });
            ...
            if (backendApi && this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideRefreshDatasetCommand) {
                ...
                if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                    gridMenuCustomItems.push({
                        ...
                        title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.refreshDatasetCommandKey}`, 'TEXT_REFRESH_DATASET', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.refreshDatasetCommand),
                        disabled: false,
                        command: commandName,
                        positionOrder: 57
                    });
            ...
            if (this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideTogglePreHeaderCommand) {
                ...
                if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                    gridMenuCustomItems.push({
                        ...
                        title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.togglePreHeaderCommandKey}`, 'TEXT_TOGGLE_PRE_HEADER_ROW', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.togglePreHeaderCommand),
                        disabled: false,
                        command: commandName,
                        positionOrder: 53
                    });
            ...
            if (this.sharedService.gridOptions && this._gridMenuOptions && !this._gridMenuOptions.hideClearAllSortingCommand) {
                ...
                if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                    gridMenuCustomItems.push({
                        ...
                        title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearAllSortingCommandKey}`, 'TEXT_CLEAR_ALL_SORTING', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.clearAllSortingCommand),
                        disabled: false,
                        command: commandName,
                        positionOrder: 51
                    });
        ...
        if ((((_b = this.sharedService.gridOptions) === null || _b === void 0 ? void 0 : _b.enableExport) || ((_c = this.sharedService.gridOptions) === null || _c === void 0 ? void 0 : _c.enableTextExport)) && this._gridMenuOptions && !this._gridMenuOptions.hideExportCsvCommand) {
            const commandName = 'export-csv';
            if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                gridMenuCustomItems.push({
                    iconCssClass: this._gridMenuOptions.iconExportCsvCommand || 'fa fa-download',
                    title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportCsvCommandKey}`, 'TEXT_EXPORT_TO_CSV', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportCsvCommand),
                    disabled: false,
                    command: commandName,
                    positionOrder: 54
                });
        ...
        if (this.sharedService.gridOptions && this.sharedService.gridOptions.enableExcelExport && this._gridMenuOptions && !this._gridMenuOptions.hideExportExcelCommand) {
            ...
            if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                gridMenuCustomItems.push({
                    ...
                    title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportExcelCommandKey}`, 'TEXT_EXPORT_TO_EXCEL', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportExcelCommand),
                    disabled: false,
                    command: commandName,
                    positionOrder: 55
                });
        ...
        if ((((_d = this.sharedService.gridOptions) === null || _d === void 0 ? void 0 : _d.enableExport) || ((_f = this.sharedService.gridOptions) === null || _f === void 0 ? void 0 : _f.enableTextExport)) && this._gridMenuOptions && !this._gridMenuOptions.hideExportTextDelimitedCommand) {
            const commandName = 'export-text-delimited';
            if (!originalCustomItems.some(item => item !== 'divider' && item.hasOwnProperty('command') && item.command === commandName)) {
                gridMenuCustomItems.push({
                    iconCssClass: this._gridMenuOptions.iconExportTextDelimitedCommand || 'fa fa-download',
                    title: this.extensionUtility.translateWhenEnabledAndServiceExist(`${translationPrefix}${commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportTextDelimitedCommandKey}`, 'TEXT_EXPORT_TO_TAB_DELIMITED', commandLabels === null || commandLabels === void 0 ? void 0 : commandLabels.exportTextDelimitedCommand),
                    disabled: false,
                    command: commandName,
                    positionOrder: 56
                });

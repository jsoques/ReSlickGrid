...
exports.parseFormatterWhenExist = exports.exportWithFormatterWhenDefined = exports.getAssociatedDateFormatter = exports.getValueFromParamsOrFormatterOptions = exports.autoAddEditorFormatterToColumnsWithEditor = void 0;
...
function getAssociatedDateFormatter(fieldType, defaultSeparator) {
    const defaultDateFormat = utilities_1.mapMomentDateFormatWithFieldType(fieldType);
    return (_row, _cell, value, columnDef, _dataContext, grid) => {
        ...
        const inputDateFormat = utilities_1.mapMomentDateFormatWithFieldType(inputType);

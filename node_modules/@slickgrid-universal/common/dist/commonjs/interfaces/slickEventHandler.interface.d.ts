 ...
 */
export declare type GetSlickEventType<T> = T extends (infer U)[] ? U : T extends (...args: any[]) => infer U ? U : T extends SlickEvent<infer U> ? U : T;
declare type Handler<H> = (e: SlickEventData, data: H) => void;

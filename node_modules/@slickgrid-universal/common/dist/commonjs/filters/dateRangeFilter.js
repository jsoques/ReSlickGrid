...
class DateRangeFilter {
    ...
    buildDatePickerInput(searchTerms) {
        ...
        if (pickerValues) {
            this._currentDates = pickerValues;
            const outFormat = utilities_1.mapMomentDateFormatWithFieldType(this.columnFilter.type || this.columnDef.type || index_1.FieldType.dateIso);
        ...
        const pickerOptions = {
            ...
            onChange: (selectedDates) => {
                if (Array.isArray(selectedDates)) {
                    ...
                    const outFormat = utilities_1.mapMomentDateFormatWithFieldType(this.columnDef.outputType || this.columnFilter.type || this.columnDef.type || index_1.FieldType.dateIso);

...
class CompoundInputFilter {
    ...
    buildInputElement() {
        ...
        inputElm.setAttribute('aria-label', (_g = (_f = this.columnFilter) === null || _f === void 0 ? void 0 : _f.ariaLabel) !== null && _g !== void 0 ? _g : `${utilities_1.toSentenceCase(columnId + '')} Search Filter`);
        return inputElm;
    }

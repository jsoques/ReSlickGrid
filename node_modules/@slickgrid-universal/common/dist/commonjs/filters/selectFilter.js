...
class SelectFilter {
    ...
    init(args) {
        ...
        if (this._isMultipleSelect && ((_a = this.columnDef) === null || _a === void 0 ? void 0 : _a.filter)) {
            this.columnDef.filter.emptySearchTermReturnAllValues = (_c = (_b = this.columnDef.filter) === null || _b === void 0 ? void 0 : _b.emptySearchTermReturnAllValues) !== null && _c !== void 0 ? _c : false;
        }
    ...
    renderDomElement(inputCollection) {
        ...
        if (!Array.isArray(inputCollection) && ((_a = this.collectionOptions) === null || _a === void 0 ? void 0 : _a.collectionInsideObjectProperty)) {
            ...
            inputCollection = utilities_1.getDescendantProperty(inputCollection, collectionInsideObjectProperty || '');
        }
        ...
        const selectBuildResult = index_2.buildSelectEditorOrFilterDomElement('filter', newCollection, this.columnDef, this.grid, this.isMultipleSelect, this.translaterService, this.searchTerms || []);
    ...
    initMultipleSelectTemplate() {
        ...
        if (this._isMultipleSelect) {
            ...
            options.countSelected = (isTranslateEnabled && ((_a = this.translaterService) === null || _a === void 0 ? void 0 : _a.translate)) ? this.translaterService.translate(`${translationPrefix}X_OF_Y_SELECTED`) : (_b = this._locales) === null || _b === void 0 ? void 0 : _b.TEXT_X_OF_Y_SELECTED;
            options.allSelected = (isTranslateEnabled && ((_c = this.translaterService) === null || _c === void 0 ? void 0 : _c.translate)) ? this.translaterService.translate(`${translationPrefix}ALL_SELECTED`) : (_d = this._locales) === null || _d === void 0 ? void 0 : _d.TEXT_ALL_SELECTED;
            options.okButtonText = (isTranslateEnabled && ((_e = this.translaterService) === null || _e === void 0 ? void 0 : _e.translate)) ? this.translaterService.translate(`${translationPrefix}OK`) : (_f = this._locales) === null || _f === void 0 ? void 0 : _f.TEXT_OK;
            options.selectAllText = (isTranslateEnabled && ((_g = this.translaterService) === null || _g === void 0 ? void 0 : _g.translate)) ? this.translaterService.translate(`${translationPrefix}SELECT_ALL`) : (_h = this._locales) === null || _h === void 0 ? void 0 : _h.TEXT_SELECT_ALL;

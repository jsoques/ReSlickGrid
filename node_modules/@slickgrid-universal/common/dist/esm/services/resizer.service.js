...
export class ResizerService {
    ...
    init(grid, gridParentContainerElm) {
      ...
      You can fix this by setting your gridOption to use "enableAutoResize" or create an instance of the ResizerService by calling bindAutoResizeDataGrid()`);
        ...
        if ((_j = this.gridOptions) === null || _j === void 0 ? void 0 : _j.enableColumnResizeOnDoubleClick) {
            ...
            this._eventHandler.subscribe(onColumnsResizeDblClickHandler, (_e, args) => {
    ...
    resizeGridWithDimensions(newSizes) {
        ...
        if ((newSizes || availableDimensions) && this._gridDomElm.length > 0) {
            ...
            if (((_a = this.gridOptions) === null || _a === void 0 ? void 0 : _a.enableAutoSizeColumns) && this._grid.autosizeColumns) {
                // make sure that the grid still exist (by looking if the Grid UID is found in the DOM tree) to avoid SlickGrid error "missing stylesheet"
                if (this.gridUid && $(`.${this.gridUid}`).length > 0) {
                    this._grid.autosizeColumns();
                }
            }
            else if (this.gridOptions.enableAutoResizeColumnsByCellContent && (!((_b = this._lastDimensions) === null || _b === void 0 ? void 0 : _b.width) || newWidth !== ((_c = this._lastDimensions) === null || _c === void 0 ? void 0 : _c.width))) {
                // we can call our resize by content here (when enabled)
                // since the core Slick.Resizer plugin only supports the "autosizeColumns"
                this.resizeColumnsByCellContent(false);
            }
    ...
    resizeColumnsByCellContent(recalculateColumnsTotalWidth = false) {
        ...
        let reRender = false;
        let readItemCount = 0;
        if ((!Array.isArray(dataset) || dataset.length === 0) || (this._hasResizedByContentAtLeastOnce && ((_a = this.gridOptions) === null || _a === void 0 ? void 0 : _a.resizeByContentOnlyOnFirstLoad) && !recalculateColumnsTotalWidth)) {
            return;
        }
        ...
        if (this._totalColumnsWidthByContent === 0 || recalculateColumnsTotalWidth) {
            ...
            for (const columnDef of columnDefinitions) {
                columnWidths[columnDef.id] = (_c = (_b = columnDef.originalWidth) !== null && _b !== void 0 ? _b : columnDef.minWidth) !== null && _c !== void 0 ? _c : 0;
            }
            ...
            for (const column of columnDefinitions) {
                const resizeAlwaysRecalculateWidth = (_f = (_d = column.resizeAlwaysRecalculateWidth) !== null && _d !== void 0 ? _d : this.resizeByContentOptions.alwaysRecalculateColumnWidth) !== null && _f !== void 0 ? _f : false;
        ...
        const viewportWidth = (_h = (_g = this._gridParentContainerElm) === null || _g === void 0 ? void 0 : _g.offsetWidth) !== null && _h !== void 0 ? _h : 0;
    ...
    resizeGridWhenStylingIsBrokenUntilCorrected() {
        ...
        const headerElm = document.querySelector(`.${this.gridUid} .slick-header`);
        const viewportElm = document.querySelector(`.${this.gridUid} .slick-viewport`);
        ...
        if (headerElm && viewportElm && this.gridOptions.autoFixResizeWhenBrokenStyleDetected) {
            this._intervalId = setInterval(async () => {
                ...
                const isGridVisible = !!((_d = (_c = document.querySelector(`.${this.gridUid}`)) === null || _c === void 0 ? void 0 : _c.offsetParent) !== null && _d !== void 0 ? _d : false);
                if (isGridVisible && (isResizeRequired || resizeGoodCount < autoFixResizeRequiredGoodCount) && ((containerElmOffset === null || containerElmOffset === void 0 ? void 0 : containerElmOffset.left) > 0 || (containerElmOffset === null || containerElmOffset === void 0 ? void 0 : containerElmOffset.top) > 0)) {
                    ...
                    const isGridStillVisible = !!((_g = (_f = document.querySelector(`.${this.gridUid}`)) === null || _f === void 0 ? void 0 : _f.offsetParent) !== null && _g !== void 0 ? _g : false);

import { ContextMenuOption, MenuCommandItemCallbackArgs, MenuOptionItemCallbackArgs, SlickContextMenu, SlickEventData, SlickGrid } from './index';
export interface ContextMenu extends ContextMenuOption {
    ...
    onBeforeMenuClose?: (e: SlickEventData, args: {
        cell: number;
        row: number;
        grid: SlickGrid;
        menu: HTMLElement;

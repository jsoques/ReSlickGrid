...
import { Column, ColumnSort, Editor, EditorValidationResult, ElementPosition, FormatterResultObject, GridOption, MultiColumnSort, PagingInfo, SingleColumnSort, SlickCellSelectionModel, SlickCompositeEditor, SlickDataView, SlickEditorLock, SlickEvent, SlickRowSelectionModel } from './index';
...
export interface OnDragEventArgs extends SlickGridEventData {
    ...
    originalX: number;
    originalY: number;
    available: HTMLElement | HTMLElement[];
    drag: HTMLElement;
    drop: HTMLElement | HTMLElement[];
    helper: HTMLElement;
    proxy: HTMLElement;
    target: HTMLElement;
    mode: string;

...
class SlickPaginationComponent {
    constructor(paginationService, pubSubService, sharedService, translaterService) {
        ...
        this._locales = this.gridOptions && this.gridOptions.locales || common_1.Constants.locales;
        ...
        if (this._enableTranslate && this.pubSubService && this.pubSubService.subscribe) {
            const translateEventName = (_b = (_a = this.translaterService) === null || _a === void 0 ? void 0 : _a.eventName) !== null && _b !== void 0 ? _b : 'onLanguageChange';
            this._subscriptions.push(this.pubSubService.subscribe(translateEventName, () => this.translatePaginationTexts(this._locales)));
        }
    ...
    renderPagination(gridParentContainerElm) {
        ...
        if (paginationTemplate) {
            ...
            this._paginationElement = temp.firstChild;
    ...
    translatePaginationTexts(locales) {
        var _a;
        if (this._enableTranslate && ((_a = this.translaterService) === null || _a === void 0 ? void 0 : _a.translate)) {
            const translationPrefix = common_1.getTranslationPrefix(this.gridOptions);
